            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <div class="{{ !old('purchase_code') ? "d-none" : "" }} form-group mt-4" id="code">
                    ...
                    <!-- <small class="badge badge-pill badge-secondary" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{ __('Please enter Envato Purchase Code. Its required Extended Licence')}}">
