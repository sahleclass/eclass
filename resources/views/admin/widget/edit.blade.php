					...
					<form action="{{action('WidgetController@update')}}" method="POST">
						...
						<div class="row">
							...
							<div style="{{$show->widget_enable == 0 ? 'display: none' : ''}}" id="update-password">
								<div class="row">
									<div class="form-group col-md-3">
										...
										<input value="{{ $show ? $show->widget_one : '' }}" autofocus name="widget_one"
											type="text" class="form-control" placeholder="{{ __('Enter Widget One Title')}}" required />
									</div>
									<div class="form-group col-md-3">
								...
								<div class="row">
									<div class="form-group col-md-3">
										<label for="heading">{{ __('Widget Two Title') }}<sup
												class="redstar text-danger">*</sup></label>
										<input value="{{ optional($show)->widget_two }}" autofocus name="widget_two"
											type="text" class="form-control" placeholder="{{ __('Enter Widget Two Title')}}" required />
									</div>
									<div class="form-group col-md-3">
								...
								<div class="row">
									<div class="form-group col-md-3">
										<label for="heading">{{ __('Widget Three Title') }}<sup
												class="redstar">*</sup></label>
										<input value="{{ optional($show)->widget_three }}" autofocus name="widget_three"
											type="text" class="form-control" placeholder="{{ __('Enter Widget Three Title')}}" required />
										</div>
									</div>
								</div>
