							...
							<div class="col-md-12">
				                ...
				                <div class="row" style="{{ $careers['one_enable']==1 ? '' : 'display:none' }}" id="section_one">
				                	<div class="col-md-6">
					                    ...
					                    <input value="{{ $careers['one_heading'] }}" name="one_heading" type="text" class="form-control" placeholder="{{ __('Enter Heading') }}" />
					                </div>

									<div class="col-md-6">
					                    <label class="text-dark" for="one_text">{{ __('Section One Text :') }} <span class="text-danger">*</span></label>
					                    <textarea name="one_text" rows="1"  class="form-control" placeholder="{{ __('Enter Text') }}" >{{ $careers['one_text'] }}</textarea>
					                    <br>
				                  	</div>

				                  	<div class="col-md-6">
					                    <label class="text-dark" for="one_btntxt">{{ __('Section One button Text :') }} <span class="text-danger">*</span></label>
					                    <input value="{{ $careers['one_btntxt'] }}" name="one_btntxt" type="text" class="form-control" placeholder="{{ __('Enter Button Text') }}" />
									</div>

									<div class="col-md-6">
					                    <label class="text-dark" for="one_btntxt">{{ __('Section One button Link :') }} <span class="text-danger">*</span></label>
					                    <input value="{{ $careers['three_btntxt'] }}" name="three_btntxt" type="text" class="form-control" placeholder="{{ __('Enter Button Link') }}" />
									</div>
									  ...
									  <label class="text-dark">{{ __('Section One Image :') }}<span class="text-danger">*</span></label><br>
											...
											<div class="custom-file">
												<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="one_video" aria-describedby="inputGroupFileAddon01">
							...
							<div class="col-md-12">
		                        ...
		                        <div class="row" style="{{ $careers['three_enable']==1 ? '' : 'display:none' }}" id="section_three">
		                        	...
		                        	<div class="col-md-6">
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="three_bg_image" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
									...
									<div class="col-md-6">
					                    ...
					                    <input value="{{ $careers['three_heading'] }}" name="three_heading" type="text" class="form-control" placeholder="{{ __('Enter Heading') }}"/>
					                </div>
							...
							<div class="col-md-12">
		                        ...
		                        <div class="row" style="{{ $careers['four_enable']==1 ? '' : 'display:none' }}" id="section_four">
									...
									<div class="col-md-4">
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_img_one" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
									  ...
									  <label class="text-dark">{{ __('Section Four Image Two :') }}<span class="text-danger">*</span></label><br>
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_img_two" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
									  ...
									  <label class="text-dark">{{ __('Section Four Image Three :') }}<span class="text-danger">*</span></label><br>
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_img_three" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
									  ...
									  <label class="text-dark">{{ __('Section Four Image Four :') }}<span class="text-danger">*</span></label><br>
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_img_four" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
				                  	...
				                  	<div class="col-md-4">
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_img_five" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
									  ...
									  <label class="text-dark">{{ __('Section Four Image Six :') }}<span class="text-danger">*</span></label><br>
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_img_six" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
									  ...
									  <label class="text-dark">{{ __('Section Four Image Seven :') }}<span class="text-danger">*</span></label><br>
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_img_seven" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
									  ...
									  <label class="text-dark">{{ __('Section Four Image Eight :') }}<span class="text-danger">*</span></label><br>
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_img_eight" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
									  ...
									  <label class="text-dark">{{ __('Section Four Image Nine :') }}<span class="text-danger">*</span></label><br>
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_img_nine" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
							...
							<div class="col-md-12">
		                        ...
		                        <div class="row" style="{{ $careers['five_enable']==1 ? '' : 'display:none' }}" id="section_five">
									<div class="col-md-4">
					                    ...
					                    <input value="{{ $careers['five_heading'] }}" name="five_heading" type="text" class="form-control" placeholder="{{ __('Enter Heading') }}" />
					                </div>

				                  	<div class="col-md-4">
					                    <label class="text-dark" for="five_text">{{ __('Section Five Text :') }} <span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_text'] }}" name="five_text" type="text" class="form-control" placeholder="{{ __('Enter Text') }}" />
									</div>
									...
									<div class="col-md-4 display-none">
					                    ...
					                    <input value="{{ $careers['five_icon'] }}" name="five_icon" type="text" class="form-control" placeholder="{{ __('Select Icon') }}" />
					                    <br>
									</div>

									<div class="col-md-6">
					                    <label class="text-dark" for="five_textone">{{ __('Section Five Topic One :') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_textone'] }}" name="five_textone" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}"/>
					                    <br>
									
					                    <label class="text-dark" for="five_texttwo">{{ __('Section Five Topic Two : ') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_texttwo'] }}" name="five_texttwo" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}" />
					                    <br>
									
					                    <label class="text-dark" for="five_textthree">{{ __('Section Five Topic Three :') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_textthree'] }}" name="five_textthree" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}" />
					                    <br>
									
					                    <label class="text-dark" for="five_textfour">{{ __('Section Five Topic Four :') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_textfour'] }}" name="five_textfour" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}" />
					                    <br>
									
					                    <label class="text-dark" for="five_textfive">{{ __('Section Five Topic Five :') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_textfive'] }}" name="five_textfive" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}" />
					                    <br>
									
					                    <label class="text-dark" for="five_textsix">{{ __('Section Five Topic Six :') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_textsix'] }}" name="five_textsix" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}') }}" />
					                    <br>
									
					                    <label class="text-dark" for="five_textseven">{{ __('Section Five Topic Seven :') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_textseven'] }}" name="five_textseven" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}" />
					                    <br>
									
					                    <label class="text-dark" for="five_texteight">{{ __('Section Five Topic Eight :') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_texteight'] }}" name="five_texteight" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}"/>
					                    <br>
									
					                    <label class="text-dark" for="five_textnine">{{ __('Section Five Topic Nine :') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_textnine'] }}" name="five_textnine" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}" />
					                    <br>
									
					                    <label class="text-dark" for="five_textten">{{ __('Section Five Topic Ten :') }}<span class="text-danger">*</span></label>
					                    <input value="{{ $careers['five_textten'] }}" name="five_textten" type="text" class="form-control" placeholder="{{ __('Enter Topic') }}" />
					                    <br>
									</div>

									<div class="col-md-6">
					                   	<label class="text-dark" for="five_dtlone">{{ __('Section Five Detail One :') }}<span class="text-danger">*</span></label>
					                    <textarea name="five_dtlone" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}" >{{ $careers['five_dtlone'] }}</textarea>
					                    <br>
					                   
					                   	<label class="text-dark" for="five_dtltwo">{{ __('Section Five Detail two :') }}<span class="text-danger">*</span></label>
					                    <textarea name="five_dtltwo" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}" >{{ $careers['five_dtltwo'] }}</textarea>
					                    <br>
					                    
					                
					                   	<label class="text-dark" for="five_dtlthree">{{ __('Section Five Detail three :') }}<span class="text-danger">*</span></label>
					                    <textarea name="five_dtlthree" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}" >{{ $careers['five_dtlthree'] }}</textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlfour">{{ __('Section Five Detail four :') }} <span class="text-danger">*</span></label>
					                    <textarea name="five_dtlfour" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}" >{{ $careers['five_dtlfour'] }}</textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlfive">{{ __('Section Five Detail five :') }} <span class="text-danger">*</span></label>
					                    <textarea name="five_dtlfive" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}" >{{ $careers['five_dtlfive'] }}</textarea>
					                    <br>
					                   
					                   	<label class="text-dark" for="five_dtlsix">{{ __('Section Five Detail six :') }}<sup class="redstar">*</sup></label>
					                    <textarea name="five_dtlsix" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}" >{{ $careers['five_dtlsix'] }}</textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlseven">{{ __('Section Five Detail seven :') }}<span class="text-danger">*</span></label>
					                    <textarea name="five_dtlseven" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}" >{{ $careers['five_dtlseven'] }}</textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtleight">{{ __('Section Five Detail eight :') }}<span class="text-danger">*</span></label>
					                    <textarea name="five_dtleight" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}" >{{ $careers['five_dtleight'] }}</textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlnine">{{ __('Section Five Detail nine :') }} <span class="text-danger">*</span></label>
					                    <textarea name="five_dtlnine" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}') }}" >{{ $careers['five_dtlnine'] }}</textarea>
					                    <br>
					                    
					                   	<label class="text-dark" for="five_dtlten">{{ __('Section Five Detail ten :') }} <span class="text-danger">*</span></label>
					                    <textarea name="five_dtlten" rows="1"  class="form-control" placeholder="{{ __('Enter Deatil') }}" >{{ $careers['five_dtlten'] }}</textarea>
					                    <br>
					                </div>
		                        </div>
				            </div>
