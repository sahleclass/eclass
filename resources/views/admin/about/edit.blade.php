									  ...
									  <!-- ============== -->
										...
										<label class="text-dark">{{ __('Section One BackgroundImage :') }}:<span class="text-danger">*</span></label><br>
												...
												<div class="custom-file">
													<input type="file" accept="image/*" class="custom-file-input" id="inputGroupFile01" name="one_image" aria-describedby="inputGroupFileAddon01">
								...
								<div class="col-md-12">
			                        ...
			                        <br><br>
					                  ...
					                  <div class="col-md-6">
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="two_imageone" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
									  ...
									  <label class="text-dark">{{ __('Section Two Instructor Image Two :') }}:<span class="text-danger">*</span></label><br>
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="two_imagetwo" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
					                  ...
					                  <div class="col-md-6">
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="two_imagefour" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row" style="{{ $data['four_enable']==1 ? '' : 'display:none' }}" id="sec_four">
										...
										<div class="custom-file">
											<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_imageone" aria-describedby="inputGroupFileAddon01">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
										...
										@endif
					                  	...
					                  	<div class="col-md-6">
											...
											<div class="custom-file">
												<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="four_imagetwo" aria-describedby="inputGroupFileAddon01">
												<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
											</div>
											</div>
									...
									<div class="row" style="{{ $data['five_enable']==1 ? '' : 'display:none' }}" id="sec_five">
					                  ...
					                  <div class="col-md-12">
										...
										<label class="text-dark">{{ __('Section Five Image One :') }}<span class="text-danger">*</span></label><br>
											...
											<div class="custom-file">
												<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="five_imageone" aria-describedby="inputGroupFileAddon01">
												<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
											</div>
											</div>
					                  ...
					                  <div class="col-md-4">
											...
											<div class="custom-file">
												<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="five_imagetwo" aria-describedby="inputGroupFileAddon01">
												<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
											</div>
											</div>
										...
										<label class="text-dark">{{ __('Section Five Image Three :') }}<span class="text-danger">*</span></label><br>
											...
											<div class="custom-file">
												<input accept="image/*" type="file" class="custom-file-input" id="inputGroupFile01" name="five_imagethree" aria-describedby="inputGroupFileAddon01">
												<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
											</div>
											</div>
