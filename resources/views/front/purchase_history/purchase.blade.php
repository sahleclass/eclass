			            	...
			            	<tr>
				    			<td >
									...
									@if($order->bundle['preview_image'] !== NULL && $order->bundle['preview_image'] !== '')
										<a href="{{ route('bundle.detail', ['id' => $order->bundle->id]) }}"><img src="{{ asset('images/bundle/'. $order->bundle->preview_image) }}" class="img-fluid" alt="course"></a>
									@else
										<a href="{{ route('bundle.detail', ['id' => $order->bundle->id]) }}"><img src="{{ Avatar::create($order->bundle->title)->toBase64() }}" class="img-fluid" alt="course"></a>
									@endif
									@endif
									@endif
								</div>
