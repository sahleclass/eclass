...
<meta property="og:asset" content="{{ url()->full() }}">
...
<section id="home" class="slider-area fix p-relative">
    ...
    @if($slider->status == 1)
        <div class="single-slider slider-bg" style="background-image: asset('{{ asset('images/slider/'.$slider['image']) }}'); background-size: cover;">
            <div class="container">
               <div class="row">
...
<section class="about-area about-p pt-120 pb-120 p-relative fix">
    <div class="animations-02">
        <img src="{{asset('frontcss/img/bg/an-img-02.png')}}" alt="contact-bg-an-01">
    </div>
    <div class="container">
...
<section id="learning-courses" class="learning-courses-main-block pt-120 pb-120 p-relative fix">
    <div class="animations-01"><img src="{{asset('frontcss/img/bg/an-img-03.png')}}" alt="an-img-01"></div>
                            ...
                            <ul>
                                ...
                                <li class="protip-wish-btn">
                                    <form id="demo-form2" method="post"
                                        action="{{ asset('show/wishlist', $c->id) }}" data-parsley-validate
                                ...
                                <li class="protip-wish-btn-two heart-fill">
                                    <form id="demo-form2" method="post"
                                        action="{{ asset('remove/wishlist', $c->id) }}" data-parsley-validate
                                        class="form-horizontal form-label-left">
                                        {{ csrf_field() }}
                    ...
                    <div class="thumb fix ">
                        ...
                        <div class="courses-icon">
                            <ul>
                                ...
                                <li class="protip-wish-btn">
                                    <form id="demo-form2" method="post"
                                        action="{{ asset('show/wishlist', $discount->id) }}" data-parsley-validate
                                        class="form-horizontal form-label-left">
                                        {{ csrf_field() }}
                                ...
                                <li class="protip-wish-btn-two heart-fill">
                                    <form id="demo-form2" method="post"
                                        action="{{ asset('remove/wishlist', $discount->id) }}" data-parsley-validate
                                        class="form-horizontal form-label-left">
                                        {{ csrf_field() }}
...
<section class="steps-area p-relative">
    <div class="animations-10"><img src="{{asset('frontcss/img/bg/an-img-10.png')}}" alt="an-img-01"></div> 
    <div class="container">
...
@if(isset($gets)) 
            ...
            <section class="cta-area cta-bg pt-50 pb-50" style="background-image:asset({{ asset('/images/joininstructor/'.$gets->img) }})">
                @else
            <section class="cta-area cta-bg pt-50 pb-50" style="background-image:asset({{ asset('/images/joininstructor/'.$gets->img) }})">
 ...
 <section class="faq-area pt-120 pb-120 p-relative fix">
    <div class="animations-10"><img src="{{asset('frontcss/img/bg/an-img-04.png')}}" alt="an-img-01"></div>
    <div class="animations-08"><img src="{{asset('frontcss/img/bg/an-img-05.png')}}" alt="contact-bg-an-01"></div>
    <div class="container">
        <div class="row justify-content-center  align-items-center">
            @if (isset($faqs))
            <div class="col-lg-7">
...
@if($hsetting->video_enable == 1 &&  isset($videosetting) )
    <section class="cta-area cta-bg pt-160 pb-160 cta-area-videosetting" style="background-image:asset({{ ('images/videosetting/'.$videosetting->image) }});">
        <div class="overlay-bg"></div>
        <div class="container">
            <div class="row justify-content-center  align-items-center">
               ...
               <div class="col-lg-4">
                        ...
                        <div class="s-video-content">
                            <a href="{{$videosetting->asset}}" class="popup-video mb-50"><img src={{ asset('frontcss/img/bg/play-button.png') }} alt="circle_right"></a>
...
<section class="testimonial-area pt-120 pb-115 p-relative fix">
    <div class="animations-01"><img src="{{asset('frontcss/img/bg/an-img-03.png')}}" alt="an-img-01"></div>
    <div class="animations-02"><img src="{{asset('frontcss/img/bg/an-img-04.png')}}" alt="contact-bg-an-01"></div>
    <div class="container">
       <div class="row">
           <div class="col-lg-12">
...
@if($hsetting->get_enable == 1 && isset($get_enable))
 <section class="about-area about-p pt-120 pb-120 p-relative fix" style="background-image:asset({{asset('frontcss/img/bg/admission_bg.png')}}); background-repeat: no-repeat; background-position: top;">
    <div class="container">
        <div class="row justify-content-center align-items-center">
             <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="s-about-img p-relative  wow fadeInLeft animated" data-animation="fadeInLeft" data-delay=".4s">
                ...
                <div class="class-item mb-30 courses-item hover-zoomin">
                    ...
                    <div class="class-img">
                        <div class="class-img-outer">
                            <a href="{{ route('allinstructor/profile',$inst->id) }}"> <img src="{{ asset('/images/user_img/'.$inst['user_img']) }}" alt="class image"></a>
                                        ...
                                        <div class="tooltip">
                                            ...
                                            <span class="tooltiptext">
                                                <div class="instructor-home-social-icon">
                                                    <ul>
                                                        <li><a href="http://www.linkedin.com/shareArticle?mini=true&asset={{ $asset }}&title=Default+share+text&summary=" target="_blank" title="Linkedin"><b><i class="fab fa-linkedin-in"></i></b></a></li>
                                                        <li><a href="https://www.facebook.com/sharer/sharer.php?&asset={{ $asset }}" target="_blank" title="Facebook"><b><i class="fab fa-facebook-f"></i></b></a></li>
                                                        <li><a href="https://twitter.com/intent/tweet?text=Default+share+text&asset={{ $asset }}" target="_blank" title="Twitter"><b><i class="fab fa-twitter"></i></b></a></li>
                                                        <li><a href="https://telegram.me/share/asset?asset={{ $asset }}&text=Default+share+text" target="_blank" title="Telegram"><b><i class="fab fa-telegram"></i></b></a></li>
                                                        <li><a href="https://wa.me/?text={{ $asset }}" target="_blank" title="Whatsapp"><b><i class="fab fa-whatsapp"></i></b></a></li>
                                                    </ul>
                                                </div>
                                            </span>
                                        </div>
        ...
        <div class="row class-active">
            ...
            <div class="col-lg-4 col-md-6 ">
                ...
                <div class="class-item mb-30 courses-item hover-zoomin">
                    ...
                    <div class="class-img">
                        <div class="class-img-outer">
                            <a href="{{ route('ins.sluging', ['id' => $inst->id, 'slug' => $inst->slug]) }}"> <img src="{{ $inst['image'] ? asset('/files/institute/'.$inst->image) : Avatar::create($inst->fname)->toBase64() }}" alt="class image"></a>
                            <div class="courses-icon">
                                <ul>
                                    <li>
        ...
        <div class="row align-items-center">
            <div class="col-xl-7 col-lg-7">
                <div class="section-title newslater-title">
                    <div class="icon">
                        <img src="{{asset('frontcss/img/icon/send-mail.png')}}" alt="img">
                    </div>
                    <div class="text">
            ...
            <div class="col-xl-5 col-lg-5">
                 <form name="ajax-form" id="contact-form4" action="{{asset('store-newsletter')}}" method="post" class="contact-form newslater">
                    @csrf
...
<script src="{{ asset('js/colorbox-script.js')}}"></script>
@endsection 