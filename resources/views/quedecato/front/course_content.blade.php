                        ...
                        <div class="row mb-4">
                            <div class="col-lg-6 col-md-6">
                                <div class="learning-questions-block btm-40">
                                    ...
                                    @else
                                        ...
                                        @endforeach
                                    @endif
                                    <div class="learning-questions-heading learning-questions-browse-heading"><a href="#" id="goTab4" title="browse">{{ __('Browse questions') }}</a>
                                    </div>
                                </div>
                            </div>
                            @if(count($announsments) > 0)
                            <div class="col-lg-6 col-md-6">
                                <div class="learning-questions-block btm-40 learning-announcement-block">
                                                ...
                                                <div class="mb-0">
                                                    <button class="btn btn-link" data-toggle="collapse" data-target="#collapseFour{{ $announsment->id }}" aria-expanded="true" aria-controls="collapseFour">
                                                        ...
                                                        <div class="row pt-1 mb-2">
                                                            <div class="col-lg-6">
                                                                <div class="section">
                                                                    <a href="#" title="questions">{{ $course->user->fname }} {{ $announsment->user->lname }}</a> 
                                                                    <a href="#" title="questions">{{ date('jS F Y', strtotime($announsment->created_at)) }}</a>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                    ...
                                    @endif
                                    <div class="learning-questions-heading learning-questions-browse-heading"><a id="goTab5" href="" title="browse">{{ __('Browse announcements') }}</a>
                                    </div>
                                </div>
                            </div>
                            @endif
                                                ...
                                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseThree{{ $ques->id }}" aria-expanded="true" aria-controls="collapseThree">
                                                    ...
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-lg-3 col-3"> 
                                                            <div class="profile-heading text-right"><a href="#" data-toggle="modal" data-target="#myModalanswer{{ $ques->id }}" title="response">{{ __('Add Answer') }}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </button>
                                                        ...
                                                        <div class="row">
                                                          <div class="col-md-12">
                                                            ...
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <option value="none" selected disabled hidden>{{ __('Select Chapter') }}</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="assignment-tab-block">
                                            <div class="categories-block assign-tab-one text-center p-4">
                                                <ul>
                                                    <li class="mb-2"><h5>{{ $appoint->title }}</h5></li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <button  type="submit" class="display-inline btn btn-primary" title="{{ __('Remove From cart')}}"> {{ __('Delete') }}</button>
                                                      </form>

                                                    </li>
                                                    @if($appoint->accept == 1)
                                                    <li><a href="" class="btn btn-primary text-white" data-toggle="modal" data-target="#myModalresponse" title="response">{{ __('Response')}}</a></li>
