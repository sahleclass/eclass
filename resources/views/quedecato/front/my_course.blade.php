            ...
            <div class="col-lg-4 col-md-6 ">
                <div class="courses-item mb-30 hover-zoomin">
                    <div class="thumb fix">
                        ...
                        <a href="single-courses.html"><img src="{{ asset('images/course/'.$enrol->courses->preview_image) }}" alt="contact-bg-an-01"></a>
                        @else
                        <a href="single-courses.html"><img src="{{ asset('images/course/'.$enrol->courses->preview_image) }}" alt="contact-bg-an-01"></a>
                        @endif
                    </div>
                    <div class="courses-content">                                    
                        ...
                        <h3><a href="single-courses.html"> {{ optional($enrol->courses->user)['fname'] }}</a></h3>
                    ...
                    <div class="icon">
                        @if($enrol->user['user_img'] !== NULL && $enrol->user['user_img'] !== '')
                        <img src="{{ asset('images/user_img/'.$enrol->user['user_img']) }}" alt="img">
                        @else
