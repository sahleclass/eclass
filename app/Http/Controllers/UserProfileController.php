...
class UserProfileController extends Controller
{
    public function userprofilepage($id)
    {
        if(Auth::check())
        {
            ...
            return view('quedecato.front.user_profile.profile',compact('orders', 'course', 'countries', 'states', 'cities')); 
    ...
    public function leaderboard()
    {
        ...
        return view('quedecato.front.leaderboard', compact('user', 'social_total', 'total_courses', 'progres', 'quiz_total', 'total_progess', 'all_total', 'all_total_reverse', 'live_meeting_count'));
