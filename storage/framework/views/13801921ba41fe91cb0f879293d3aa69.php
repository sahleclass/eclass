                ...
                <div class="about-content-sidebar">
                    <div class="container-xl">
                        ...
                        <div class="about-reward-badges">
                            <img src="<?php echo e(url('images/badges/1.png')); ?>" class="img-fluid" alt="" data-toggle="tooltip" data-placement="bottom" title="Member Since <?php echo e($course->user->created_at); ?>">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="<?php echo e(route('instructor.profile', ['id' => $course->user->id, 'name' => $user->name] )); ?>" class="btn btn-primary" title="course"><?php echo e(__('Profile')); ?></a>
                            </div>
