                ...
                <div id="prime-next-item-description-block<?php echo e($c->id); ?>" class="prime-description-block">
                    <div class="prime-description-under-block">
                        <div class="prime-description-under-block">
                            ...
                            <div class="main-des">
                                <p><?php echo e(__('Last Updated:')); ?> <?php echo e(date('jS F Y', strtotime($c->updated_at))); ?></p>
                            </div>
...
<script>
  feather.replace()
</script><?php /**PATH C:\laragon\www\eclass\resources\views/tabs.blade.php ENDPATH**/ ?>