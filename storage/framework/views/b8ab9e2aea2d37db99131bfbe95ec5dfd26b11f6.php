<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
        ...
        <a class="dropdown-item btn btn-link" data-toggle="modal"
            data-target="#deleteinstructor<?php echo e($id); ?>" title="<?php echo e(__('Delete')); ?>">
            <i class="feather icon-delete mr-2"></i><?php echo e(__('Delete')); ?></a>
        </a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Allinstructor.view')): ?>
        <button type="button" class="dropdown-item" data-toggle="modal"
            data-target="#exampleStandardModal2<?php echo e($id); ?>" title="<?php echo e(__('View')); ?>">
...
<!-- delete Modal start -->
<div class="modal fade bd-example-modal-sm" id="deleteinstructor<?php echo e($id); ?>"
...
<!-- delete Model ended -->
<?php /**PATH C:\laragon\www\eclass_purchasecopy\resources\views/admin/allinstructor/action.blade.php ENDPATH**/ ?>