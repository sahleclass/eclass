                ...
                <form enctype="multipart/form-data" id="demo-form2" method="post"
                  ...
                  <div class="row" style="display:none">
                    <div class="col-md-12" id="previewUrl">
                      ...
                      <div id="document11">
                        <label for="exampleInputSlug"><?php echo e(__('Preview')); ?> <?php echo e(__('UploadVideo')); ?>:</label>
                         <!-- =========== -->
                       <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01"><?php echo e(__('Upload')); ?></span>
                      ...
                      <div id="document22">
                        <label for=""><?php echo e(__('Preview')); ?> <?php echo e(__('URL')); ?>: </label>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\laragon\www\eclass\resources\views/admin/course/courseclass/index.blade.php ENDPATH**/ ?>