  ...
  <div class="col-lg-12">
    ...
    <div class="card m-b-30">
        ...
        <form action="<?php echo e(route('course.update',$cor->id)); ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="title" id="title" value="<?php echo e($cor->title); ?>">
            </div>

            <div class="col-md-6">
              <label for="exampleInputSlug"><?php echo e(__('Slug')); ?>: <sup class="redstar">*</sup></label>
              <input id="slug" type="text" class="form-control" name="slug" value="<?php echo e($cor->slug); ?>" required>
            </div>
          </div>
          <br>
      ...
      <div class="row">
        ...
        <?php if(Auth::user()->role == 'instructor'): ?>
        <div class="col-md-6">
          <label><?php echo e(__('PreviewImage')); ?><?php echo e(__(':size: 270x200')); ?></label>
          <br>
          <!-- ====================== -->
          <div class="input-group mb-3">
            <div class="input-group-prepend">
...
<?php $__env->stopSection(); ?><?php /**PATH C:\laragon\www\eclass\resources\views/admin/course/editcor.blade.php ENDPATH**/ ?>