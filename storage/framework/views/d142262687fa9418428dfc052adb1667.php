                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="social-link">
                                            <a href="#" title="<?php echo e(__('Admin')); ?>"
                                                onclick="switchUserType('admin')"><?php echo e(__('Admin')); ?></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="social-link">
                                            <a href="#" title="<?php echo e(__('User')); ?>" onclick="switchUserType('user')"><?php echo e(__('User')); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eclass_purchasecopy\resources\views/auth/login.blade.php ENDPATH**/ ?>